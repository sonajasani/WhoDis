...
const EditUserCard = () => {
    ...
    return (
        <div className='edit-user-container'>
            ...
            <div className='edit-user-info' style={{
                ...
                <div className='user-info'>
                    <div className='user-name'><p id='user-card-name'>username:</p>   <p>{currentUserName}</p>
                    </div>
                    <div className='user-bio'>
                        <p id='user-card-bio'>bio:</p>   <p>{currentBio}</p></div>
                </div>
            </div>
            <div className='edit-user-form'>
                ...
                <form className='edit-form-user' onSubmit={submitForm}>
                    ...
                    <p id='no-edit-msg'>You may not edit a demo user</p>
                     }
                </form>
            </div>
        </div>
