        ...
        <div className='server-form-container'>
            ...
            {toggleForm &&
                ...
                <form onSubmit={submitForm} className='server-form'>
                    <h1 id='create-server-title'>Create New Server</h1>
                    <ul id='create-server-errors'>
                    {   errors.length > 0 && errors.map((err) => (
                        <li>{err}</li>
                    ))}
                    </ul>
                    <div className='server-create-input'>
                        <label htmlFor='name' id='server-create-name'>Server Name</label>
                        <input
                    ...
                    <div className='server-banner-input'>
                        <label htmlFor='banner_url' id='server-create-banner'>Banner</label>
                        <input
                            draggable="false"
                            type="file"
                    ...
                    <button type='submit' className='server-create-btn'>Submit</button>
                </form>
                </Modal>
}   
        </>
