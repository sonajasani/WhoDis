        ...
        <div className='edit-server-container'>
            ...
            <div className='delete-server-container'> 
                <form className='delete-server-form' onSubmit={submitDelete}>
                    <p id='delete-server-title'>Are you sure you want to delete this server?</p>
            ...
            <Modal onClose={() => setToggleForm(false)}>
                <form onSubmit={submitForm} className='edit-server-form'>
                    <h1 id='edit-server-title-name'>Edit Server</h1>
                    <ul id='edit-server-errors'>
                    ...
                    <div className='server-banner-input'>
                        <label htmlFor='banner_url' className='edit-server-banner'>Banner Image</label>
                        <input
                            className='edit-server-file'
                    ...
                    <div className='server-icon-input'>
                        <label htmlFor='server_icon_url' className='edit-server-banner'>Server Icon</label>
                        <input
                            className='edit-server-file'
